    ...
    <div className='w-full mt-6'>
      <div className='relative max-w-screen-xl mx-auto text-center'>
        ...
        <div className='absolute top-0 w-full h-full '>
            {images.map((elem,index)=>(elem.isActive && <img className='absolute w-52 rounded-lg -translate-x-[50%] -translate-y-[50%]' style={{top: elem.top, left: elem.left}} src={elem.url} alt="" />))}
        </div>
      </div>
