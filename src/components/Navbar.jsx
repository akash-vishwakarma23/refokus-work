...
function Navbar() {
  return (
    <div className='max-w-screen-xl mx-auto py-6 font-["satoshi"] flex items-center justify-between border-b-[1px] border-zinc-700  '>
        ...
        <div className='links flex gap-14 ml-20'>
            {["Home", "Work", "Culture" ,"" , "News"].map((elem,index) =>(
                ...
                <a key={index} className='text-sm font-regular flex items-center gap-1' href="">
